...
#   open_ai_api = "sk-pxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxT3BlbkFJm9Dn8pnyBU0naiFfV0PXn3cyBCfOOm0l_9-Eps9Wwi0WX3e0eHcxWaml8A"
  ...
  with open('./test_nootebooks/question_bank.json', 'r') as f:
        question_bank = json.load(f)
  processor = QuestionProcessor(question_bank)
  ...
  if uploaded_files:
      ...
      if chat_on:
          ...
          similar_questions = processor.find_similar_questions(prompt,1)
          few_shot_prompt = create_few_shot_prompt(similar_questions,0.8)
          few_shot_prompt = format_examples(few_shot_prompt)
